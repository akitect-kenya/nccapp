<?php include('header.php'); ?>
  <body id="login">
	...
	<img src="images/banner.png" class="img-polaroid">
												...
												jQuery("#login_form").submit(function(e){
														...
														$.ajax({
															...
															if(html=='true')
															{
																...
																$.jGrowl("Welcome to Nairobi County Integrated Database", { header: 'Access Granted' });
															var delay = 1000;
																setTimeout(function(){ window.location = 'coordinator.php'  }, delay);  
															}else if (html == 'true_user'){
																$.jGrowl("Loading Please Wait......", { sticky: true });
																$.jGrowl("Welcome to Welcome to Nairobi County Integrated Database", { header: 'Access Granted' });
															var delay = 1000;
